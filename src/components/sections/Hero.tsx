  ...
  return (
    <section className="min-h-screen flex items-center justify-center py-10 ">
      ...
      <div className="w-full max-w-450 mx-auto px-4 grid grid-cols-1 lg:grid-cols-14 gap-12 items-center">
        ...
        <div className="relative  lg:col-span-7 h-[80vh] lg:h-[90vh] lg:max-w-160 group">
        ...
        <div className="lg:col-span-7 flex flex-col space-y-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-extrabold uppercase text-[#FFFFFF] leading-tight">
              I&apos;m Steve-Milner <br />
              <span className="text-[#FFB400]">Web Designer</span>
            </h1>
          </div>

          <p className="text-[#FFFFFF] leading-relaxed max-w-lg xl:text-lg">
          ...
          <button className="group relative inline-flex items-center gap-4 w-fit xl:pl-8 xl:pr-20 pl-6 pr-16 py-4 border-2 border-[#FFB400] rounded-full overflow-hidden transition-all duration-300 cursor-pointer">
